...
export const CommercialPlotsExplorer: React.FC = () => {
  ...
  return (
    <section id="commercial-plots-inventory" className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-12 py-12 space-y-8">
      ...
      {/* Results Header Count, Sort & View Mode Toggle */}
      <div className="flex flex-wrap items-center justify-between gap-3 text-xs text-slate-500 font-sans px-1">
        <div className="flex flex-wrap items-center gap-2 sm:gap-3">
          <span>
            ...
            <strong>{liveCommercialPlots.length}</strong> commercial plots &amp; plazas
          </span>
          ...
          <div className="overflow-x-auto">
            <table className="w-full min-w-[1100px] text-left text-xs border-collapse">
              <thead className="bg-[#4c050d] text-white uppercase text-[10px] tracking-wider font-semibold border-b border-[#7b002c]">
                <tr>
                  <th className="p-4 w-[280px] min-w-[280px] whitespace-nowrap">Plot # &amp; Name</th>
                  ...
                  <th className="p-4 w-[160px] min-w-[160px] whitespace-nowrap">Road Width</th>
                  <th className="p-4 w-[150px] min-w-[150px] whitespace-nowrap">Height Bylaws</th>
                  <th className="p-4 w-[140px] min-w-[140px] whitespace-nowrap">Price (PKR)</th>
              ...
              <tbody className="divide-y divide-slate-100 text-slate-700">
                {filteredPlots.map((plot) => (
                  <tr key={plot.id} className="hover:bg-rose-50/40 transition-colors">
                    ...
                    <td className="p-4 w-[160px] min-w-[160px] font-sans text-slate-600 truncate">{plot.roadWidth}</td>
                    <td className="p-4 w-[150px] min-w-[150px] font-sans text-slate-600 whitespace-nowrap">{plot.heightPermission}</td>
