      ...
      >
        ...
        >
          ...
          <div className="hidden xl:flex items-center gap-5 2xl:gap-6 shrink-0 whitespace-nowrap">
            ...
            {/* Action Button - Phone Hotline Pill with Girl Headphone Avatar */}
            <a
              href="tel:+923044811717"
              className={`inline-flex items-center gap-2.5 pl-2 pr-5 2xl:pr-6 py-1.5 text-xs sm:text-sm font-bold rounded-full shadow-lg transition-all duration-300 hover:scale-105 active:scale-95 whitespace-nowrap ${isSolidNav
          ...
          <button
            ...
            className={`xl:hidden p-2.5 sm:p-3 rounded-full flex items-center justify-center transition-all active:scale-95 shrink-0 z-50 cursor-pointer ${isSolidNav
