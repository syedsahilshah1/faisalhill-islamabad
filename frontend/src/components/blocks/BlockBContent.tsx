    ...
    <div className="space-y-12 sm:space-y-16 lg:space-y-20">
      ...
      <section id="plots-for-sale" className="scroll-mt-28 space-y-6">
              ...
              >
                ...
                <div className="p-5 sm:p-6 pt-0 space-y-2">
                  <div className="flex items-center gap-2">
                    ...
                    <a
                      href={`https://wa.me/923331113177?text=Hello!%20I%20am%20interested%20in%20Faisal%20Hills%20Block%20B%20Plot%20${plot.plotNumber}%20(${plot.size}).%20Please%20share%20latest%20price%20and%20transfer%20details.`}
                      target="_blank"
                      rel="noopener noreferrer"
        ...
        <div className="p-6 sm:p-8 bg-rose-50/70 border border-rose-200/80 rounded-3xl text-slate-900 shadow-2xs flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <a
            href="https://wa.me/923331113177?text=Hello!%20I%20want%20to%20list%20or%20sell%20my%20plot%20in%20Faisal%20Hills%20Block%20B."
            target="_blank"
            rel="noopener noreferrer"
