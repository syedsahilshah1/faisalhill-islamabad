...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const description = seo?.meta_description || 'Contact Faisal Hills sales office. Call +92 331 3339997 or WhatsApp for verified plot rates, booking forms, site visits, and RDA NOC verification.';
  const canonical = seo?.canonical_url || `${BASE_URL}/contact`;
  const ogImg = seo?.og_image || `${BASE_URL}/images/faisal-hills-arc-gate.webp`;
