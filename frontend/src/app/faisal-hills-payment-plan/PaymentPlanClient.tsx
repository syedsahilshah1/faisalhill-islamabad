    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <section className="max-w-[1440px] mx-auto px-6 lg:px-12 py-12 space-y-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-5 flex justify-center">
            <ScrollReveal direction="right" delay={120} className="w-full max-w-md">
      ...
      <section className="max-w-[1440px] mx-auto px-6 lg:px-12 py-12 bg-white border-y border-slate-200 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-4">
          <ScrollReveal direction="left" delay={80}>
            <div className="p-6 bg-slate-50 border border-slate-200/60 rounded-2xl space-y-3 h-full hover:shadow-md transition-shadow">
      ...
      <section className="max-w-[1440px] mx-auto px-6 lg:px-12 py-12 space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {[
            ...
            <ScrollReveal key={pidx} direction="pop" delay={pidx * 60}>
              <div
                className="bg-white rounded-3xl border border-slate-200 shadow-2xs hover:shadow-xl hover:border-[#7b002c]/30 transition-all overflow-hidden flex flex-col justify-between group h-full"
              >
                <div>
                  {/* Visual Image Header */}
                  <div className="relative h-48 w-full overflow-hidden bg-slate-950">
                    ...
                    {/* Top Badges */}
                    <span className="absolute top-3 left-3 text-[10px] font-bold text-white px-2.5 py-0.5 rounded-full shadow bg-[#7b002c]">
                      {item.badge}
                    </span>
      ...
      <section id="block-wise" className="max-w-[1440px] mx-auto px-6 lg:px-12 py-12 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 pt-2">
          {[
            ...
            <ScrollReveal key={bidx} direction="pop" delay={bidx * 50}>
              <div
                className="bg-white rounded-3xl border border-slate-200 shadow-2xs hover:shadow-xl hover:border-[#7b002c]/30 transition-all overflow-hidden flex flex-col justify-between group h-full"
              >
                <div>
      ...
      <section className="max-w-[1440px] mx-auto px-6 lg:px-12 py-12 space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
          <ScrollReveal direction="left" delay={80}>
            <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm space-y-4 h-full">
      ...
      <section className="max-w-[1440px] mx-auto px-6 lg:px-12 py-12 space-y-8 bg-white border-y border-slate-200">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start max-w-6xl mx-auto">
          ...
          <div className="lg:col-span-4">
            <ScrollReveal direction="right" delay={120}>
              <div className="space-y-4 bg-slate-900 text-white p-6 rounded-2xl border border-slate-800 shadow-lg">
          ...
          {[
            {
              ...
              desc: "Covers road layouts, water conduits, street lighting, and underground utility networks. Inclusive in the Prime Block; billed separately in others. Always ask if they are inclusive before booking."
            },
            {
              title: "Registration & Transfer Fee",
              desc: "Charged at formal registration of allotment. If buying a resale plot, a transfer fee is set by the society and paid during documentation."
            },
            {
              title: "Possession Charges",
              desc: "Falls due when plot is handed over. Covers final demarcation and connection readiness for utilities. Represents roughly 10% of total plot price."
            },
            {
              title: "GST & Government Taxes",
              desc: "Charged as per current federal budgets. Includes transfer tax and CVTs. Filer and non-filer status materially changes what you pay."
            }
          ].map((c, cidx) => (
            <ScrollReveal key={cidx} direction="pop" delay={cidx * 50}>
              <div className="p-5 bg-white border border-slate-200 rounded-xl space-y-2 h-full hover:shadow-md transition-shadow">
                <strong className="text-[#7b002c] block font-serif">{c.title}</strong>
      ...
      <section className="max-w-[1440px] mx-auto px-6 lg:px-12 py-12 bg-white border-y border-slate-200 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto pt-4 text-xs font-sans text-slate-600">
          <ScrollReveal direction="pop" delay={50}>
            <div className="p-5 bg-slate-50 border border-slate-200 rounded-2xl space-y-2 h-full">
      ...
      <section className="max-w-[1440px] mx-auto px-6 lg:px-12 py-12 space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 pt-6">
          {[
            { num: "01", step: "Step 1", title: "Shortlist Block", desc: "Choose between possession cash plots or installment inventory." },
            { num: "02", step: "Step 2", title: "Availability Request", desc: "Ask for written quotes on block sizes, including development charges." },
            { num: "03", step: "Step 3", title: "Visit Site", desc: "Walk the streets, check the road widths, and see active homes." },
            { num: "04", step: "Step 4", title: "Fill Form", desc: "Verify sizes, dimensions, and total prices on the application sheet." },
            { num: "05", step: "Step 5", title: "Documents", desc: "Submit applicant and next-of-kin CNICs, NICOP, and photographs." },
            { num: "06", step: "Step 6", title: "Booking Payment", desc: "Submit Pay Order or draft to Faisal Town. Collect official stamped receipts." },
            { num: "07", step: "Step 7", title: "Allotment", desc: "Receive booking confirmation and allotment letters carrying plot numbers." },
            { num: "08", step: "Step 8", title: "Maintain Plan", desc: "Keep up with quarterly payments and request updated statements annualy." },
          ].map((st, sidx) => (
            <ScrollReveal key={sidx} direction="pop" delay={sidx * 40}>
              <div className="bg-white p-6 rounded-2xl border border-slate-200/80 shadow-xs hover:shadow-md hover:-translate-y-0.5 transition-all duration-300 flex flex-col justify-between space-y-4 h-full">
                <div className="flex items-center justify-between">
                  <span className="w-9 h-9 rounded-xl bg-[#7b002c]/5 text-[#7b002c] flex items-center justify-center font-bold text-sm">{st.num}</span>
                  <span className="text-[10px] text-slate-400 font-bold uppercase tracking-wider font-sans">{st.step}</span>
                </div>
      ...
      <section className="max-w-[1440px] mx-auto px-6 lg:px-12 py-12">
        <ScrollReveal direction="up" delay={50}>
          <div className="bg-slate-900 text-white rounded-3xl p-8 lg:p-12 space-y-10 border border-slate-800 shadow-xl">
            {/* Why Choose Us */}
      ...
      <section className="max-w-[1440px] mx-auto px-6 lg:px-12 py-12 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-2 text-xs font-sans text-slate-600 italic">
          <ScrollReveal direction="pop" delay={50}>
            <div className="p-6 bg-white border border-slate-200 rounded-2xl space-y-3 h-full hover:shadow-md transition-shadow">
      ...
      <section className="max-w-[1440px] mx-auto px-6 lg:px-12 pb-16">
        <ScrollReveal direction="pop" delay={80}>
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-slate-950 via-slate-900 to-slate-950 text-white p-8 lg:p-12 border border-slate-800 shadow-2xl flex flex-col items-center justify-center text-center space-y-6">
            <div className="absolute top-0 right-0 w-80 h-80 bg-[#7b002c]/20 rounded-full blur-[100px] pointer-events-none" />
